...
/**
 * Undergraduate CoursePanel — lists modules and tracks completion progress.
 * Records course_id in module_progress for accurate reporting.
 */
public class CoursePanel extends JPanel {
    ...
    // ---------------------------------------------------------------------
    // NEW: Mark completion with course_id included
    ...
    // Helper: resolve course_id quickly from module_id
