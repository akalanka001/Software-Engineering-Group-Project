...
public class EnrollmentPanel extends JPanel {
    ...
    // Maximum payment slip file size (5 MB)
    private static final long MAX_SLIP_SIZE = 5L * 1024 * 1024; // bytes
    ...
    private void chooseFile() {
        ...
        chooser.setDialogTitle("Select Payment Slip (JPEG/PNG/IMG, ≤ 5 MB)");
        chooser.setFileSelectionMode(JFileChooser.FILES_ONLY);
        chooser.setAcceptAllFileFilterUsed(false);
        chooser.addChoosableFileFilter(
                new FileNameExtensionFilter("Image Files (*.jpeg, *.jpg, *.png, *.img)",
                        "jpeg","jpg","png","img"));
        ...
        if (r==JFileChooser.APPROVE_OPTION) {
            ...
            if (!(name.endsWith(".jpeg") || name.endsWith(".jpg")
                    || name.endsWith(".png") || name.endsWith(".img"))) {
                JOptionPane.showMessageDialog(this,
                        "Invalid file format!\nPlease select an image file: .jpeg, .jpg, .png, or .img.",
            ...
            if (size > MAX_SLIP_SIZE) {
                double mb = size / (1024.0 * 1024);
                JOptionPane.showMessageDialog(this,
                        String.format("File too large (%.2f MB).\nMaximum allowed size is 5 MB.",
                                mb),
    ...
    private void enrollCourse() {
        ...
        if (selectedFile == null) {
            JOptionPane.showMessageDialog(this, "Please attach your valid payment slip before enrolling.");
            return;
        }
